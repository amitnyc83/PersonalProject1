...
#
# product1 = Product.create(name: "Air Max 90 Mars Landing", brand: "Nike", description: "You can finally reach new levels of galactical swag after buying the Air Max 90 Mars Landing. This AM 90 comes with an orange upper, orange Nike “Swoosh”, black midsole, and a grey sole. These sneakers released in March 2019 and retailed for $160. Create more problems for Houston and place a Bid for these on StockX today.", price: 170, quantity: 10, )
# product1 = Product.create(name: "Jordan 1 Retro", brand: "Nike", description: "Jordan Brand adds a new colorway to it’s hot streak of Jordan 1 releases with the Air Jordan 1 “Obsidian / University Blue”, now available on StockX. Since its debut in 1985, the Air Jordan 1 has been a cultural monument, breaking barriers between the court and the streets. Jordan Brand has continued to shed new light on this timeless silhouette and does so with this release.
...
# product1 = Product.create(name: "Adidas Nizza Lo", brand: "Adidas", description: "Stan Smith Classic", price: 100, quantity: 100, seller_id: 1 )
